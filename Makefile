SERVICE = narrativeviewers
SERVICE_CAPS = NarrativeViewers
SPEC_FILE = NarrativeViewers.spec
URL = https://kbase.us/services/narrativeviewers
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
install-nms-client:
	kb-sdk install https://raw.githubusercontent.com/kbase/narrative_method_store/master/NarrativeMethodStore.spec
