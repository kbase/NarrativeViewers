...
class NarrativeMethodStore(object):
    ...
    def list_categories(self, params, context=None):
        ...
        :returns: multiple set - (1) parameter "categories" of mapping from
           ...
           dynamically registered methods.) -> structure: parameter "id" of
           ...
           String, parameter "output_types" of list of String, (3) parameter
           "apps" of mapping from String to type "AppBriefInfo" -> structure:
           ...
           String to type "TypeInfo" (@optional icon landing_page_url_prefix
           loading_error) -> structure: parameter "type_name" of String,
           parameter "name" of String, parameter "subtitle" of String,
           parameter "tooltip" of String, parameter "description" of String,
           parameter "icon" of type "ScreenShot" -> structure: parameter
           "url" of type "url", parameter "view_method_ids" of list of
           String, parameter "import_method_ids" of list of String, parameter
    ...
    def list_methods(self, params, context=None):
        ...
        :returns: instance of list of type "MethodBriefInfo" (Minimal
           ...
           methods.) -> structure: parameter "id" of String, parameter
           ...
           "output_types" of list of String
        """
        return self._client.call_method(
    ...
    def list_methods_full_info(self, params, context=None):
        ...
        :returns: instance of list of type "MethodFullInfo" (Full information
           ...
           registered methods.) -> structure: parameter "id" of String,
           ...
           parameter "url" of type "url", parameter "publications" of list of
           type "Publication" (Publication info can get complicated.  To keep
           things simple, we only allow a few things now: pmid - pubmed id,
           if present, we can use this id to pull all publication info we
           want display_text - what is shown to the user if there is no
           pubmed id, or if the pubmed id is not valid link - a link to the
           paper, also not needed if pmid is valid, but could be used if
           pubmed is down) -> structure: parameter "pmid" of String,
           parameter "display_text" of String, parameter "link" of type "url"
        """
        return self._client.call_method(
    ...
    def list_methods_spec(self, params, context=None):
        ...
        :returns: instance of list of type "MethodSpec" (The method
           ...
           defined for dynamically registered methods.) -> structure:
           parameter "id" of String, parameter "module_name" of String,
           parameter "git_commit_hash" of String, parameter "name" of String,
           parameter "ver" of String, parameter "subtitle" of String,
           ...
           names)) -> structure: parameter "constant_ref" of list of String,
           parameter "parameter_id" of String, parameter "subdata_included"
           of list of String, parameter "path_to_subdata" of list of String,
           parameter "selection_id" of String, parameter
           "selection_description" of list of String, parameter
           "description_template" of String, parameter "fixed_parameters" of
           list of type "FixedMethodParameter" (a fixed parameter that does
           not appear in the method input forms, but is informational for
           users in describing a backend parameter that cannot be changed
           (e.g. if a service picks a fixed parameter for say Blast)) ->
           structure: parameter "ui_name" of String, parameter "description"
           of String, parameter "behavior" of type "MethodBehavior"
           (Determines how the method is handled when run. kb_service_name -
           name of service which will be part of fully qualified method name,
           optional field (in case it's not defined developer should enter
           fully qualified name with dot into 'kb_service_method'.
           kb_service_version - optional git commit hash defining version of
           repo registered dynamically. kb_service_input_mapping - mapping
           from input parameters to input service method arguments.
           ...
           back-end operations. kb_service_input_mapping - mapping from input
           parameters to input service method arguments.
           kb_service_output_mapping - mapping from output of service method
           to final output of narrative method. @optional python_function
           kb_service_name kb_service_method kb_service_input_mapping
           kb_service_output_mapping) -> structure: parameter "python_class"
           of String, parameter "python_function" of String, parameter
           "kb_service_url" of String, parameter "kb_service_name" of String,
           parameter "kb_service_version" of String, parameter
           "kb_service_method" of String, parameter "script_module" of
           String, parameter "script_name" of String, parameter
           "script_has_files" of type "boolean" (@range [0,1]), parameter
           ...
           as arguement. Optional field, in case this field is not defined
           (or null) whole object will be sent as method argument instead of
           ...
           parameter "narrative_system_variable" of String, parameter
           "target_property" of String, parameter "target_type_transform" of
           String, parameter "script_input_mapping" of list of type
           "ScriptInputMapping" (input_parameter - parameter_id, if not
           specified then one of 'constant_value' or
           'narrative_system_variable' should be set. constant_value -
           constant value, could be even map/array, if not specified then
           'input_parameter' or 'narrative_system_variable' should be set.
           narrative_system_variable - name of internal narrative framework
           ...
           'input_parameter' is defined but value of this parameter is left
           empty by user); so this mode has lower priority when used with
           another mode. target_property - name of script parameter.
           target_type_transform - none/string/int/float/ref, optional field,
           default is 'none' (it's in plans to support list<type>,
           mapping<type> and tuple<t1,t2,...> transformations). @optional
           input_parameter constant_value narrative_system_variable
           generated_value @optional target_property target_type_transform)
           -> structure: parameter "input_parameter" of String, parameter
           "constant_value" of unspecified object, parameter
           "narrative_system_variable" of String, parameter "generated_value"
           of type "AutoGeneratedValue" (prefix - optional string
           ...
           concatenated after generated part @optional prefix symbols suffix)
           -> structure: parameter "prefix" of String, parameter "symbols" of
           Long, parameter "suffix" of String, parameter "target_property" of
           String, parameter "target_type_transform" of String, parameter
           "script_output_mapping" of list of type "ScriptOutputMapping"
           (input_parameter - parameter_id, if not specified then one of
           'constant_value' or 'narrative_system_variable' should be set.
           script_output_path - list of properties and array element
           positions defining JSON-path traversing through which we can find
           necessary value. constant_value - constant value, could be even
           map/array, if not specified then 'input_parameter' or
           'narrative_system_variable' should be set.
           ...
           - none/string/int/float/list<type>/mapping<type>/ref, optional
           field, default is no transformation. @optional input_parameter
           script_output_path constant_value narrative_system_variable
           @optional target_property target_type_transform) -> structure:
           parameter "input_parameter" of String, parameter
           "script_output_path" of list of String, parameter "constant_value"
           of unspecified object, parameter "narrative_system_variable" of
           String, parameter "target_property" of String, parameter
           "target_type_transform" of String, parameter "job_id_output_field"
           of String
        """
        return self._client.call_method(
    ...
    def list_types(self, params, context=None):
        ...
        :param params: instance of type "ListParams" (These parameters do
           ...
           'release').) -> structure: parameter "limit" of Long, parameter
           "offset" of Long, parameter "tag" of String
        :returns: instance of list of type "TypeInfo" (@optional icon
           ...
           of list of String, parameter "landing_page_url_prefix" of String,
    ...
    def validate_method(self, params, context=None):
        ...
        :returns: instance of type "ValidationResults" -> structure:
           ...
           "git_commit_hash" of String, parameter "name" of String, parameter
           "ver" of String, parameter "authors" of list of type "username",
           parameter "kb_contributors" of list of type "username", parameter
           "contact" of type "email", parameter "subtitle" of String,
           parameter "tooltip" of String, parameter "description" of String,
           parameter "technical_description" of String, parameter
           "suggestions" of type "Suggestions" -> structure: parameter
           "related_methods" of list of String, parameter "next_methods" of
           list of String, parameter "related_apps" of list of String,
           parameter "next_apps" of list of String, parameter "icon" of type
           "Icon" -> structure: parameter "url" of type "url", parameter
           "categories" of list of String, parameter "screenshots" of list of
           type "ScreenShot" -> structure: parameter "url" of type "url",
           parameter "publications" of list of type "Publication"
           ...
           "replacement_text" of String, parameter "widgets" of type
           "WidgetSpec" (specify the input / ouput widgets used for
           rendering) -> structure: parameter "input" of String, parameter
           "output" of String, parameter "parameters" of list of type
           "MethodParameter" (Description of a method parameter. id - id of
           the parameter, must be unique within the method ui_name - short
           ...
           String, parameter "target_property" of String, parameter
           "target_type_transform" of String, parameter "job_id_output_field"
           of String, parameter "type_info" of type "TypeInfo" (@optional
